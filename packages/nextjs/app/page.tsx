  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="space-y-3">
        <InstallWalletStep complete={progress.hydrated && progress.walletInstalled} active={firstIncomplete === 0} />
        <ConnectWalletStep complete={progress.walletConnected} active={firstIncomplete === 1} />
        <SwitchNetworkStep
          complete={progress.onCorrectChain}
          active={firstIncomplete === 2}
          enabled={progress.walletConnected}
        />
        <ClaimEthStep complete={progress.hasGas} active={firstIncomplete === 3} enabled={progress.canEnter} />
        <ClaimUsdcStep complete={progress.hasUsdc} active={firstIncomplete === 4} enabled={progress.canEnter} />
      </div>
