...
*Human doc: [../REHAB_MODE.md](../REHAB_MODE.md)*

Terse implementation reference. Human narrative lives in the human doc.
...
docs/REHAB_MODE.md                                      (human doc)
docs/llm-spec/REHAB_MODE.md                             (this file)
```
