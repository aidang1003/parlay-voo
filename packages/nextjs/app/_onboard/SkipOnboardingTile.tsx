    ...
    <div className="glass-card flex items-center gap-4 rounded-2xl border border-white/5 p-5 transition-colors sm:gap-6 sm:p-6">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="mt-0.5 text-xs text-gray-400 sm:text-sm">
          Jump straight to the app. Without a wallet, gas, and USDC you can browse markets and view tickets, but you
          won&apos;t be able to place a bet until the steps above are complete.
        </p>
      </div>
