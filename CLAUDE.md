...
- `app/api/quote/route.ts` -- parlay quote computation
...
- `lib/wagmi.ts` -- wagmi config (foundry + baseSepolia chains)
...
`.env` at root holds secrets + chain config. `packages/nextjs/.env.local` auto-generated by deploy scripts.
