    ...
    <div className="animate-fade-in-up rounded-2xl border border-amber-500/20 bg-gradient-to-br from-amber-950/40 to-yellow-950/20 p-6">
      <div className="mb-3 flex items-center gap-2">
        ...
        <h3 className="text-lg font-bold text-amber-300">
          Your ticket crashed. Turn it into credit.
        </h3>
      </div>

      <p className="mb-4 text-sm text-amber-200/70">
        You staked{" "}
        <span className="font-semibold text-amber-200">${stakeFmt}</span>. Losses
        go into the VOO pool and accrue to a per-wallet balance. Lock that
        balance up for a duration of your choosing and the vault mints you{" "}
        <span className="font-semibold text-amber-200">bet-only credit</span>{" "}
        worth one year of yield on the principal. Use the credit on lossless
        parlays — wins rehab into more locked VOO, losses just burn the credit.
      </p>
        ...
        <div>
          ...
          {hasClaimable && preview > 0n && (
            <p className="mt-0.5 text-[10px] text-amber-400/60">
              ≈ ${previewFmt} credit when claimed
            </p>
          )}
        </div>
