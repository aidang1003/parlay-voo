    ...
    <div className="animate-fade-in-up rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-950/50 to-yellow-950/30 p-5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-base font-bold text-amber-200">You have ${claimableFmt} in unclaimed losses.</p>
            <p className="mt-1 text-sm text-amber-200/70">
              Lock your losses to unlock <span className="font-semibold text-amber-200">${creditFmt}</span> in bet-only
              credit. You pick the lockup duration.
            </p>
          </div>
        </div>
        <Link
