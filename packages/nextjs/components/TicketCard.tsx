            ...
            <div key={i} className="flex items-center gap-3 py-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-gray-500">
                  ...
                  <span
                    className={
                      leg.outcomeChoice === 1 ? "text-brand-green" : leg.outcomeChoice === 2 ? "text-brand-amber" : ""
                    }
                  >
      ...
      <div className="border-t border-white/5 px-6 py-4">
        <div className="mb-4 grid grid-cols-3 gap-4 text-center">
          <div>
            ...
            <p className="font-semibold text-white">${formatUSDC(ticket.stake)}</p>
          </div>
          <div>
            <p className="text-xs text-gray-500">Multiplier</p>
            <p className="gradient-text-gold text-glow-gold font-bold">{multiplier.toFixed(2)}x</p>
          </div>
          <div>
            <p className="text-xs text-gray-500">Payout</p>
            <p className="font-bold text-brand-green">${formatUSDC(ticket.payout)}</p>
          </div>
        </div>
