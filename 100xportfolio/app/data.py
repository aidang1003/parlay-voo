"""Curated historical stock dataset for 100xPortfolio.

Each cell is keyed by (industry, era). A stock's `multiple` is the approximate
total return over that 5-year window: 1.0 = flat, 2.0 = doubled, 0.0 = wiped out.
Numbers are hand-curated approximations for an educational game, not advice.
"""
...
# STOCKS[industry][era] -> list of pickable stocks for that cell.
STOCKS = {
    "Technology": {
        "1990-1994": [
