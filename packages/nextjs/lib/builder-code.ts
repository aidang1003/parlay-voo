...
function encodeBuilderCodeSuffix(code: string): `0x${string}` {
  ...
  const marker = [0x80, 0x21, 0x80, 0x21, 0x80, 0x21, 0x80, 0x21, 0x80, 0x21, 0x80, 0x21, 0x80, 0x21, 0x80, 0x21];
...
const BUILDER_CODE = process.env.NEXT_PUBLIC_BUILDER_CODE ?? "parlayvoo";
